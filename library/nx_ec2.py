...
This script also assumes there is an nx_ec2.ini file alongside it.  To specify a
different path to nx_ec2.ini, define the EC2_INI_PATH environment variable:
...
class Ec2Inventory(object):
    ...
    def read_settings(self):
        ''' Reads the settings from the nx_ec2.ini file '''

        config = ConfigParser.SafeConfigParser()
        ec2_default_ini_path = os.path.join(os.path.dirname(os.path.realpath(__file__)), 'nx_ec2.ini')
